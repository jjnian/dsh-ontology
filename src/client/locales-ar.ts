...
export const ar: Record<string, string> = {
  ...
  databaseViews: 'طرق عرض',
  databaseFunctions: 'دوال',
  databaseProcedures: 'إجراءات',
  databaseTriggers: 'مشغلات',
  databaseColumns: 'أعمدة',
  databaseKeys: 'مفاتيح',
  databaseIndexes: 'فهارس',
  lineageDetailDescription: 'الوصف',
  lineageDetailTechnical: 'تقني',
  lineageDetailGovernance: 'الحوكمة',
  lineageDetailSemantic: 'أنطولوجيا',
  lineageAddNode: 'إضافة عقدة',
  lineageConnect: 'ربط',
  lineageCancelEdit: 'إلغاء',
  lineageDelete: 'حذف',
  lineageNodeName: 'اسم العقدة',
  lineageNodeNamePlaceholder: 'أدخل اسم العقدة',
  lineageNodeType: 'نوع العقدة',
  lineageConfirm: 'تأكيد',
  lineageRelationType: 'نوع العلاقة',
  lineageConnectHint: 'تم تحديد المصدر — انقر على العقدة الهدف',
}
