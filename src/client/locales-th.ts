...
export const th: Record<string, string> = {
  ...
  databaseViews: 'มุมมอง',
  databaseFunctions: 'ฟังก์ชัน',
  databaseProcedures: 'ขั้นตอน',
  databaseTriggers: 'ทริกเกอร์',
  databaseColumns: 'คอลัมน์',
  databaseKeys: 'คีย์',
  databaseIndexes: 'ดัชนี',
  lineageDetailDescription: 'คำอธิบาย',
  lineageDetailTechnical: 'ทางเทคนิค',
  lineageDetailGovernance: 'ธรรมาภิบาล',
  lineageDetailSemantic: 'ออนโทโลยี',
  lineageAddNode: 'เพิ่มโหนด',
  lineageConnect: 'เชื่อมต่อ',
  lineageCancelEdit: 'ยกเลิก',
  lineageDelete: 'ลบ',
  lineageNodeName: 'ชื่อโหนด',
  lineageNodeNamePlaceholder: 'ป้อนชื่อโหนด',
  lineageNodeType: 'ประเภทโหนด',
  lineageConfirm: 'ยืนยัน',
  lineageRelationType: 'ประเภทความสัมพันธ์',
  lineageConnectHint: 'เลือกต้นทางแล้ว — คลิกโหนดปลายทาง',
}
