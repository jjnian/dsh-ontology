...
export const ko: Record<string, string> = {
  ...
  databaseViews: '뷰',
  databaseFunctions: '함수',
  databaseProcedures: '프로시저',
  databaseTriggers: '트리거',
  databaseColumns: '열',
  databaseKeys: '키',
  databaseIndexes: '인덱스',
  lineageDetailDescription: '설명',
  lineageDetailTechnical: '기술 속성',
  lineageDetailGovernance: '거버넌스',
  lineageDetailSemantic: '온톨로지',
  lineageAddNode: '노드 추가',
  lineageConnect: '연결',
  lineageCancelEdit: '편집 취소',
  lineageDelete: '삭제',
  lineageNodeName: '노드 이름',
  lineageNodeNamePlaceholder: '노드 이름 입력',
  lineageNodeType: '노드 유형',
  lineageConfirm: '확인',
  lineageRelationType: '관계 유형',
  lineageConnectHint: '시작점 선택됨 — 대상 노드 클릭',
}
