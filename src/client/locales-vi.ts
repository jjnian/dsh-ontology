...
export const vi: Record<string, string> = {
  ...
  databaseViews: 'Chế độ xem',
  databaseFunctions: 'Hàm',
  databaseProcedures: 'Thủ tục',
  databaseTriggers: 'Trình kích hoạt',
  databaseColumns: 'Cột',
  databaseKeys: 'Khóa',
  databaseIndexes: 'Chỉ mục',
  lineageDetailDescription: 'Mô tả',
  lineageDetailTechnical: 'Kỹ thuật',
  lineageDetailGovernance: 'Quản trị',
  lineageDetailSemantic: 'Ontology',
  lineageAddNode: 'Thêm nút',
  lineageConnect: 'Kết nối',
  lineageCancelEdit: 'Hủy',
  lineageDelete: 'Xóa',
  lineageNodeName: 'Tên nút',
  lineageNodeNamePlaceholder: 'Nhập tên nút',
  lineageNodeType: 'Loại nút',
  lineageConfirm: 'Xác nhận',
  lineageRelationType: 'Loại quan hệ',
  lineageConnectHint: 'Đã chọn nguồn — nhấp vào nút đích',
}
