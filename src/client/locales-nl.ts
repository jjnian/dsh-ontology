...
export const nl: Record<string, string> = {
  ...
  databaseViews: 'Weergaven',
  databaseFunctions: 'Functies',
  databaseProcedures: 'Procedures',
  databaseTriggers: 'Triggers',
  databaseColumns: 'Kolommen',
  databaseKeys: 'Sleutels',
  databaseIndexes: 'Indexen',
  lineageDetailDescription: 'Beschrijving',
  lineageDetailTechnical: 'Technisch',
  lineageDetailGovernance: 'Governance',
  lineageDetailSemantic: 'Ontologie',
  lineageAddNode: 'Knooppunt toevoegen',
  lineageConnect: 'Verbinden',
  lineageCancelEdit: 'Annuleren',
  lineageDelete: 'Verwijderen',
  lineageNodeName: 'Knooppuntnaam',
  lineageNodeNamePlaceholder: 'Voer knooppuntnaam in',
  lineageNodeType: 'Knooppunttype',
  lineageConfirm: 'Bevestigen',
  lineageRelationType: 'Relatietype',
  lineageConnectHint: 'Bron geselecteerd — klik op doelknooppunt',
}
