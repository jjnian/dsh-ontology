...
export const zhTW: Record<string, string> = {
  ...
  lineageLegend: '圖例',
  lineageAssetExtract: '資料抽取',
  lineageDatabaseMapping: '資料庫映射',
  lineageNoAssets: '暫無可用資料',
  lineageTargetClass: '目標類',
  lineageNoCandidates: '未抽取到候選本體',
  lineageDatabaseDdl: '資料庫 DDL',
  lineageExtractDdl: '抽取 DDL',
  lineageDdlExtracted: '已抽取並解析 DDL',
  lineageParse: '解析資料',
  lineageAcceptCandidates: '採用選中',
  lineageAutoMap: '自動映射',
  lineageAutoMapMatched: '自動匹配成功',
  lineageAutoMapNotFound: '未找到同名表或註釋',
  lineageOntologyEditor: '本體定義',
  lineageImportInstances: '導入實例',
  lineagePrimaryKey: '主鍵',
  lineageLabelColumn: '名稱列',
  lineageInstanceLimit: '導入條數',
  lineageImport: '導入',
  database: 'Database',
  ...
  databaseNoConnections: '你還沒有建立連接',
  databaseTypeSearch: '請輸入關鍵字',
  databaseComingSoon: '即將支援',
  databaseUrl: 'URL',
  databasePlaceholder: '選擇左側的連接與表開始查詢，或點 + 新建連接',
  databaseTogglePassword: '顯示 / 隱藏密碼',
  databaseSaved: '已儲存',
  databaseEdit: '編輯連接',
  databaseViews: '視圖',
  databaseFunctions: '函數',
  databaseProcedures: '存儲過程',
  databaseTriggers: '觸發器',
  databaseColumns: '列',
  databaseKeys: '鍵',
  databaseIndexes: '索引',
  lineageDetailDescription: '含義',
  lineageDetailTechnical: '技術屬性',
  lineageDetailGovernance: '治理信息',
  lineageDetailSemantic: '本體語義',
  lineageAddNode: '新增節點',
  lineageConnect: '連邊',
  lineageCancelEdit: '取消編輯',
  lineageDelete: '刪除',
  lineageNodeName: '節點名稱',
  lineageNodeNamePlaceholder: '輸入節點名稱',
  lineageNodeType: '節點類型',
  lineageConfirm: '確認',
  lineageRelationType: '關係類型',
  lineageConnectHint: '已選中起點，請點擊目標節點',
}
