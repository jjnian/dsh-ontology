...
export const fr: Record<string, string> = {
  ...
  databaseViews: 'Vues',
  databaseFunctions: 'Fonctions',
  databaseProcedures: 'Procédures',
  databaseTriggers: 'Déclencheurs',
  databaseColumns: 'Colonnes',
  databaseKeys: 'Clés',
  databaseIndexes: 'Index',
  lineageDetailDescription: 'Description',
  lineageDetailTechnical: 'Technique',
  lineageDetailGovernance: 'Gouvernance',
  lineageDetailSemantic: 'Ontologie',
  lineageAddNode: 'Ajouter nœud',
  lineageConnect: 'Connecter',
  lineageCancelEdit: 'Annuler',
  lineageDelete: 'Supprimer',
  lineageNodeName: 'Nom du nœud',
  lineageNodeNamePlaceholder: 'Entrer le nom du nœud',
  lineageNodeType: 'Type de nœud',
  lineageConfirm: 'Confirmer',
  lineageRelationType: 'Type de relation',
  lineageConnectHint: 'Source sélectionnée — cliquer le nœud cible',
}
