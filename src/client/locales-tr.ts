...
export const tr: Record<string, string> = {
  ...
  databaseViews: 'Görünümler',
  databaseFunctions: 'Fonksiyonlar',
  databaseProcedures: 'Prosedürler',
  databaseTriggers: 'Tetikleyiciler',
  databaseColumns: 'Sütunlar',
  databaseKeys: 'Anahtarlar',
  databaseIndexes: 'Dizinler',
  lineageDetailDescription: 'Açıklama',
  lineageDetailTechnical: 'Teknik',
  lineageDetailGovernance: 'Yönetim',
  lineageDetailSemantic: 'Ontoloji',
  lineageAddNode: 'Düğüm ekle',
  lineageConnect: 'Bağla',
  lineageCancelEdit: 'İptal',
  lineageDelete: 'Sil',
  lineageNodeName: 'Düğüm adı',
  lineageNodeNamePlaceholder: 'Düğüm adını girin',
  lineageNodeType: 'Düğüm türü',
  lineageConfirm: 'Onayla',
  lineageRelationType: 'İlişki türü',
  lineageConnectHint: 'Kaynak seçildi — hedef düğüme tıklayın',
}
