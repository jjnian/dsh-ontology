...
export const id: Record<string, string> = {
  ...
  databaseViews: 'Tampilan',
  databaseFunctions: 'Fungsi',
  databaseProcedures: 'Prosedur',
  databaseTriggers: 'Pemicu',
  databaseColumns: 'Kolom',
  databaseKeys: 'Kunci',
  databaseIndexes: 'Indeks',
  lineageDetailDescription: 'Deskripsi',
  lineageDetailTechnical: 'Teknis',
  lineageDetailGovernance: 'Tata kelola',
  lineageDetailSemantic: 'Ontologi',
  lineageAddNode: 'Tambah node',
  lineageConnect: 'Hubungkan',
  lineageCancelEdit: 'Batal',
  lineageDelete: 'Hapus',
  lineageNodeName: 'Nama node',
  lineageNodeNamePlaceholder: 'Masukkan nama node',
  lineageNodeType: 'Tipe node',
  lineageConfirm: 'Konfirmasi',
  lineageRelationType: 'Tipe relasi',
  lineageConnectHint: 'Sumber dipilih — klik node target',
}
