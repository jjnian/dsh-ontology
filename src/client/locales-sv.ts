export const sv: Record<string, string> = {
  ...
  databaseViews: 'Vyer',
  databaseFunctions: 'Funktioner',
  databaseProcedures: 'Procedurer',
  databaseTriggers: 'Utlösare',
  databaseColumns: 'Kolumner',
  databaseKeys: 'Nycklar',
  databaseIndexes: 'Index',
  lineageDetailDescription: 'Beskrivning',
  lineageDetailTechnical: 'Teknisk',
  lineageDetailGovernance: 'Styrning',
  lineageDetailSemantic: 'Ontologi',
  lineageAddNode: 'Lägg till nod',
  lineageConnect: 'Anslut',
  lineageCancelEdit: 'Avbryt',
  lineageDelete: 'Ta bort',
  lineageNodeName: 'Nodnamn',
  lineageNodeNamePlaceholder: 'Ange nodnamn',
  lineageNodeType: 'Nodtyp',
  lineageConfirm: 'Bekräfta',
  lineageRelationType: 'Relationstyp',
  lineageConnectHint: 'Källa vald — klicka på målnod',
}
