export const pt: Record<string, string> = {
  ...
  databaseViews: 'Visualizações',
  databaseFunctions: 'Funções',
  databaseProcedures: 'Procedimentos',
  databaseTriggers: 'Gatilhos',
  databaseColumns: 'Colunas',
  databaseKeys: 'Chaves',
  databaseIndexes: 'Índices',
  lineageDetailDescription: 'Descrição',
  lineageDetailTechnical: 'Técnico',
  lineageDetailGovernance: 'Governança',
  lineageDetailSemantic: 'Ontologia',
  lineageAddNode: 'Adicionar nó',
  lineageConnect: 'Conectar',
  lineageCancelEdit: 'Cancelar',
  lineageDelete: 'Excluir',
  lineageNodeName: 'Nome do nó',
  lineageNodeNamePlaceholder: 'Digite o nome do nó',
  lineageNodeType: 'Tipo de nó',
  lineageConfirm: 'Confirmar',
  lineageRelationType: 'Tipo de relação',
  lineageConnectHint: 'Origem selecionada — clique no nó de destino',
}
