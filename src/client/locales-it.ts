...
export const it: Record<string, string> = {
  ...
  databaseViews: 'Viste',
  databaseFunctions: 'Funzioni',
  databaseProcedures: 'Procedure',
  databaseTriggers: 'Trigger',
  databaseColumns: 'Colonne',
  databaseKeys: 'Chiavi',
  databaseIndexes: 'Indici',
  lineageDetailDescription: 'Descrizione',
  lineageDetailTechnical: 'Tecnico',
  lineageDetailGovernance: 'Governance',
  lineageDetailSemantic: 'Ontologia',
  lineageAddNode: 'Aggiungi nodo',
  lineageConnect: 'Collega',
  lineageCancelEdit: 'Annulla',
  lineageDelete: 'Elimina',
  lineageNodeName: 'Nome nodo',
  lineageNodeNamePlaceholder: 'Inserisci nome nodo',
  lineageNodeType: 'Tipo di nodo',
  lineageConfirm: 'Conferma',
  lineageRelationType: 'Tipo di relazione',
  lineageConnectHint: 'Origine selezionata — fare clic sul nodo di destinazione',
}
