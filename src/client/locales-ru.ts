...
export const ru: Record<string, string> = {
  ...
  databaseViews: 'Представления',
  databaseFunctions: 'Функции',
  databaseProcedures: 'Процедуры',
  databaseTriggers: 'Триггеры',
  databaseColumns: 'Столбцы',
  databaseKeys: 'Ключи',
  databaseIndexes: 'Индексы',
  lineageDetailDescription: 'Описание',
  lineageDetailTechnical: 'Технические',
  lineageDetailGovernance: 'Управление',
  lineageDetailSemantic: 'Онтология',
  lineageAddNode: 'Добавить узел',
  lineageConnect: 'Соединить',
  lineageCancelEdit: 'Отмена',
  lineageDelete: 'Удалить',
  lineageNodeName: 'Имя узла',
  lineageNodeNamePlaceholder: 'Введите имя узла',
  lineageNodeType: 'Тип узла',
  lineageConfirm: 'Подтвердить',
  lineageRelationType: 'Тип отношения',
  lineageConnectHint: 'Источник выбран — щёлкните целевой узел',
}
