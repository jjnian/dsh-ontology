...
export const zh = {
  ...
  lineage: '血缘图',
  lineagePathPlaceholder: '血缘 JSON 文件路径（相对会话目录），Enter 加载',
  lineageLoad: '加载',
  lineageDemo: '示例',
  lineageSearchPlaceholder: '搜索节点…',
  lineageEdgeLabels: '标签',
  lineageFit: '适应视图',
  lineageZoomIn: '放大',
  lineageZoomOut: '缩小',
  lineageLoadError: '加载血缘图失败',
  lineageInvalidGraph: '文件不是有效的血缘图（需要 { nodes, edges }）',
  lineageHint: '拖拽空白平移 · 滚轮缩放 · 双击适应视图 · 拖动节点调整布局',
  lineageEmpty: '暂无血缘数据',
  lineageDetailEvidence: '证据',
  lineageDetailProperties: '属性',
  lineageNodeRelated: '相关节点',
  lineageNodeIncoming: '上游',
  lineageNodeOutgoing: '下游',
  lineageGenerate: '从对话生成',
  lineageNoGraph: '在对话中未找到血缘图（模型需输出包含 { nodes, edges } 的 JSON）',
  lineageHistory: '历史版本',
  lineageHistoryLatest: '最新',
  lineageHistoryTurn: '第 {turn} 轮',
  lineageLegend: '图例',
  lineageAssetExtract: '资料抽取',
  lineageDatabaseMapping: '数据库映射',
  lineageNoAssets: '暂无可用资料',
  lineageTargetClass: '目标类',
  lineageNoCandidates: '未抽取到候选本体',
  lineageDatabaseDdl: '数据库 DDL',
  lineageExtractDdl: '抽取 DDL',
  lineageDdlExtracted: '已抽取并解析 DDL',
  lineageParse: '解析资料',
  lineageAcceptCandidates: '采纳选中',
  lineageAutoMap: '自动映射',
  lineageAutoMapMatched: '自动匹配成功',
  lineageAutoMapNotFound: '未找到同名表或注释',
  lineageOntologyEditor: '本体定义',
  lineageImportInstances: '导入实例',
  lineagePrimaryKey: '主键',
  lineageLabelColumn: '名称列',
  lineageInstanceLimit: '导入条数',
  lineageImport: '导入',
  database: '数据库',
  databaseConnections: '连接',
  databaseNewConnection: '新建连接',
  databaseSave: '保存',
  databaseTest: '测试连接',
  databaseConnect: '连接',
  databaseDisconnect: '断开',
  databaseDelete: '删除',
  databaseName: '名称',
  databaseHost: '主机',
  databasePort: '端口',
  ...
  databaseServerVersion: '版本 {version}',
  databaseRefresh: '刷新',
  databaseTables: '表',
  databaseSqlPlaceholder: '输入 SQL...',
  databaseRun: '执行 SQL',
  databaseUpdateResult: '影响 {affectedRows} 行',
  databaseChangedRows: '变更 {changedRows} 行',
  databaseNoRows: '无结果',
  databaseTruncated: '结果超过 500 行，仅显示前 500 行',
  databaseLoadError: '数据库请求失败',
  databaseTestOk: '连接成功 · MySQL {version}',
  databaseNoConnections: '你还没有创建连接',
  databaseTypeSearch: '请输入关键字',
  databaseComingSoon: '即将支持',
  databaseUrl: 'URL',
  databasePlaceholder: '选择左侧的连接与表开始查询，或点击 + 新建连接',
  databaseTogglePassword: '显示 / 隐藏密码',
  databaseSaved: '已保存',
  databaseEdit: '编辑连接',
  databaseViews: '视图',
  databaseFunctions: '函数',
  databaseProcedures: '存储过程',
  databaseTriggers: '触发器',
  databaseColumns: '列',
  databaseKeys: '键',
  databaseIndexes: '索引',
  lineageDetailDescription: '含义',
  lineageDetailTechnical: '技术属性',
  lineageDetailGovernance: '治理信息',
  lineageDetailSemantic: '本体语义',
  lineageAddNode: '新增节点',
  lineageConnect: '连边',
  lineageCancelEdit: '取消编辑',
  lineageDelete: '删除',
  lineageNodeName: '节点名称',
  lineageNodeNamePlaceholder: '输入节点名称',
  lineageNodeType: '节点类型',
  lineageConfirm: '确认',
  lineageRelationType: '关系类型',
  lineageConnectHint: '已选中起点，请点击目标节点',
}
...
export const en: Record<keyof typeof zh, string> = {
  ...
  lineage: 'Lineage',
  lineagePathPlaceholder: 'Lineage JSON path (relative to the session), Enter to load',
  lineageLoad: 'Load',
  lineageDemo: 'Demo',
  lineageSearchPlaceholder: 'Search nodes…',
  lineageEdgeLabels: 'Labels',
  lineageFit: 'Fit',
  lineageZoomIn: 'Zoom in',
  lineageZoomOut: 'Zoom out',
  lineageLoadError: 'Failed to load lineage',
  lineageInvalidGraph: 'Not a valid lineage graph (expected { nodes, edges })',
  lineageHint: 'Drag to pan · Wheel to zoom · Double-click to fit · Drag nodes to arrange',
  lineageEmpty: 'No lineage data',
  lineageDetailEvidence: 'Evidence',
  lineageDetailProperties: 'Properties',
  lineageNodeRelated: 'Related nodes',
  lineageNodeIncoming: 'Incoming',
  lineageNodeOutgoing: 'Outgoing',
  lineageGenerate: 'Generate from chat',
  lineageNoGraph: 'No lineage graph found in the conversation (the model must output JSON with { nodes, edges })',
  lineageHistory: 'History',
  lineageHistoryLatest: 'Latest',
  lineageHistoryTurn: 'Turn {turn}',
  lineageLegend: 'Legend',
  lineageAssetExtract: 'Extract assets',
  lineageDatabaseMapping: 'Database mapping',
  lineageNoAssets: 'No documents available',
  lineageTargetClass: 'Target class',
  lineageNoCandidates: 'No ontology candidates extracted',
  lineageDatabaseDdl: 'Database DDL',
  lineageExtractDdl: 'Extract DDL',
  lineageDdlExtracted: 'DDL extracted and parsed',
  lineageParse: 'Parse documents',
  lineageAcceptCandidates: 'Accept selected',
  lineageAutoMap: 'Auto map',
  lineageAutoMapMatched: 'Auto match found',
  lineageAutoMapNotFound: 'No matching table or comment',
  lineageOntologyEditor: 'Ontology definition',
  lineageImportInstances: 'Import instances',
  lineagePrimaryKey: 'Primary key',
  lineageLabelColumn: 'Label column',
  lineageInstanceLimit: 'Row limit',
  lineageImport: 'Import',
  database: 'Database',
  databaseConnections: 'Connections',
  databaseNewConnection: 'New connection',
  databaseSave: 'Save',
  databaseTest: 'Test connection',
  databaseConnect: 'Connect',
  databaseDisconnect: 'Disconnect',
  ...
  databaseServerVersion: 'Version {version}',
  databaseRefresh: 'Refresh',
  databaseTables: 'Tables',
  databaseSqlPlaceholder: 'Enter SQL...',
  databaseRun: 'Run SQL',
  databaseUpdateResult: 'Affected {affectedRows} rows',
  databaseChangedRows: 'Changed {changedRows} rows',
  databaseNoRows: 'No rows',
  databaseTruncated: 'More than 500 rows; showing the first 500',
  databaseLoadError: 'Database request failed',
  databaseTestOk: 'Connected · MySQL {version}',
  databaseNoConnections: 'No connections yet',
  databaseTypeSearch: 'Search database types…',
  databaseComingSoon: 'Coming soon',
  databaseUrl: 'URL',
  databasePlaceholder: 'Pick a connection and table on the left, or press + to create one',
  databaseTogglePassword: 'Show / hide password',
  databaseSaved: 'Saved',
  databaseEdit: 'Edit connection',
  databaseViews: 'Views',
  ...
  lineageDetailDescription: 'Description',
  lineageDetailTechnical: 'Technical',
  lineageDetailGovernance: 'Governance',
  lineageDetailSemantic: 'Ontology',
  lineageAddNode: 'Add node',
  lineageConnect: 'Connect',
  lineageCancelEdit: 'Cancel edit',
  lineageDelete: 'Delete',
  lineageNodeName: 'Node name',
  lineageNodeNamePlaceholder: 'Enter node name',
  lineageNodeType: 'Node type',
  lineageConfirm: 'Confirm',
  lineageRelationType: 'Relation type',
  lineageConnectHint: 'Source selected — click the target node',
}
