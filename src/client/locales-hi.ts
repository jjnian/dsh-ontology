...
export const hi: Record<string, string> = {
  ...
  databaseViews: 'व्यू',
  databaseFunctions: 'फंक्शन',
  databaseProcedures: 'प्रोसीजर',
  databaseTriggers: 'ट्रिगर',
  databaseColumns: 'कॉलम',
  databaseKeys: 'कुंजियाँ',
  databaseIndexes: 'इंडेक्स',
  lineageDetailDescription: 'विवरण',
  lineageDetailTechnical: 'तकनीकी',
  lineageDetailGovernance: 'शासन',
  lineageDetailSemantic: 'ऑन्टोलॉजी',
  lineageAddNode: 'नोड जोड़ें',
  lineageConnect: 'कनेक्ट',
  lineageCancelEdit: 'रद्द',
  lineageDelete: 'हटाएं',
  lineageNodeName: 'नोड नाम',
  lineageNodeNamePlaceholder: 'नोड नाम दर्ज करें',
  lineageNodeType: 'नोड प्रकार',
  lineageConfirm: 'पुष्टि करें',
  lineageRelationType: 'संबंध प्रकार',
  lineageConnectHint: 'स्रोत चयनित — लक्ष्य नोड पर क्लिक करें',
}
