...
export const ja: Record<string, string> = {
  ...
  lineage: 'リネージ',
  lineagePathPlaceholder: 'リネージ JSON ファイルパス（セッションディレクトリからの相対）、Enter で読み込み',
  lineageLoad: '読み込み',
  lineageDemo: 'サンプル',
  lineageSearchPlaceholder: 'ノード検索…',
  lineageEdgeLabels: 'ラベル',
  lineageFit: 'フィット',
  lineageZoomIn: '拡大',
  lineageZoomOut: '縮小',
  lineageLoadError: 'リネージの読み込みに失敗しました',
  lineageInvalidGraph: '有効なリネージグラフではありません（{ nodes, edges } が必要）',
  lineageHint: 'ドラッグで移動 · ホイールでズーム · ダブルクリックでフィット · ノードをドラッグで配置',
  lineageEmpty: 'リネージデータがありません',
  lineageDetailEvidence: 'エビデンス',
  lineageDetailProperties: '属性',
  lineageNodeRelated: '関連ノード',
  lineageNodeIncoming: '入力',
  lineageNodeOutgoing: '出力',
  lineageGenerate: '会話から生成',
  lineageNoGraph: '会話内にリネージグラフが見つかりません（{ nodes, edges } を含む JSON をモデルが出力する必要があります）',
  lineageHistory: '履歴バージョン',
  lineageHistoryLatest: '最新',
  lineageHistoryTurn: '第 {turn} ターン',
  lineageLegend: '凡例',
  lineageAssetExtract: '資料抽出',
  lineageDatabaseMapping: 'データベースマッピング',
  lineageNoAssets: '利用可能な資料はありません',
  lineageTargetClass: '対象クラス',
  lineageNoCandidates: '候補オントロジーはありません',
  lineageDatabaseDdl: 'データベース DDL',
  lineageExtractDdl: 'DDLを抽出',
  lineageDdlExtracted: 'DDLを解析しました',
  lineageParse: '資料を解析',
  lineageAcceptCandidates: '選択を採用',
  lineageAutoMap: '自動マッピング',
  lineageAutoMapMatched: '自動マッチ成功',
  lineageAutoMapNotFound: '一致するテーブルがありません',
  lineageOntologyEditor: 'オントロジー定義',
  lineageImportInstances: 'インスタンス取り込み',
  lineagePrimaryKey: '主キー',
  lineageLabelColumn: '名称列',
  lineageInstanceLimit: '取り込み件数',
  lineageImport: '取り込み',
  database: 'データベース',
  databaseConnections: '接続',
  databaseNewConnection: '新規接続',
  databaseSave: '保存',
  databaseTest: '接続テスト',
  databaseConnect: '接続',
  databaseDisconnect: '切断',
  databaseDelete: '削除',
  databaseName: '名前',
  databaseHost: 'ホスト',
  databasePort: 'ポート',
  ...
  databaseDatabase: 'データベース',
  databaseServerVersion: 'バージョン {version}',
  databaseRefresh: '更新',
  databaseTables: 'テーブル',
  databaseSqlPlaceholder: 'SQL を入力...',
  databaseRun: 'SQL を実行',
  databaseUpdateResult: '{affectedRows} 行に影響',
  databaseChangedRows: '{changedRows} 行を変更',
  databaseNoRows: '結果なし',
  databaseTruncated: '500 行を超えています。最初の 500 行を表示',
  databaseLoadError: 'データベース要求に失敗しました',
  databaseTestOk: '接続成功 · MySQL {version}',
  databaseNoConnections: '接続はまだありません',
  databaseTypeSearch: 'キーワードを入力',
  databaseComingSoon: '近日対応',
  databaseUrl: 'URL',
  databasePlaceholder: '左の接続とテーブルを選択するか、+ で新規接続を作成してください',
  databaseTogglePassword: 'パスワード表示切替',
  databaseSaved: '保存しました',
  databaseEdit: '接続を編集',
  databaseViews: 'ビュー',
  databaseFunctions: '関数',
  databaseProcedures: 'ストアドプロシージャ',
  databaseTriggers: 'トリガー',
  databaseColumns: '列',
  databaseKeys: 'キー',
  databaseIndexes: 'インデックス',
  lineageDetailDescription: '説明',
  lineageDetailTechnical: '技術属性',
  lineageDetailGovernance: 'ガバナンス',
  lineageDetailSemantic: 'オントロジー',
  lineageAddNode: 'ノード追加',
  lineageConnect: '接続',
  lineageCancelEdit: '編集取消',
  lineageDelete: '削除',
  lineageNodeName: 'ノード名',
  lineageNodeNamePlaceholder: 'ノード名を入力',
  lineageNodeType: 'ノードタイプ',
  lineageConfirm: '確認',
  lineageRelationType: '関係タイプ',
  lineageConnectHint: '始点選択済み — 対象ノードをクリック',
}
