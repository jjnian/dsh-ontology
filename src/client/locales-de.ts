...
export const de: Record<string, string> = {
  ...
  lineageNoCandidates: 'No ontology candidates',
  lineageDatabaseDdl: 'Database DDL',
  lineageExtractDdl: 'Extract DDL',
  lineageDdlExtracted: 'DDL extracted',
  ...
  lineageAutoMapNotFound: 'No matching table',
  ...
  databaseViews: 'Views',
  databaseFunctions: 'Funktionen',
  databaseProcedures: 'Prozeduren',
  databaseTriggers: 'Trigger',
  databaseColumns: 'Spalten',
  databaseKeys: 'Schlüssel',
  databaseIndexes: 'Indizes',
  lineageDetailDescription: 'Beschreibung',
  lineageDetailTechnical: 'Technisch',
  lineageDetailGovernance: 'Governance',
  lineageDetailSemantic: 'Ontologie',
  lineageAddNode: 'Knoten hinzufügen',
  lineageConnect: 'Verbinden',
  lineageCancelEdit: 'Abbrechen',
  lineageDelete: 'Löschen',
  lineageNodeName: 'Knotenname',
  lineageNodeNamePlaceholder: 'Knotennamen eingeben',
  lineageNodeType: 'Knotentyp',
  lineageConfirm: 'Bestätigen',
  lineageRelationType: 'Beziehungstyp',
  lineageConnectHint: 'Quelle ausgewählt — Zielknoten anklicken',
}
