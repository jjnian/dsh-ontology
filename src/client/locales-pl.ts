...
export const pl: Record<string, string> = {
  ...
  databaseViews: 'Widoki',
  databaseFunctions: 'Funkcje',
  databaseProcedures: 'Procedury',
  databaseTriggers: 'Wyzwalacze',
  databaseColumns: 'Kolumny',
  databaseKeys: 'Klucze',
  databaseIndexes: 'Indeksy',
  lineageDetailDescription: 'Opis',
  lineageDetailTechnical: 'Techniczne',
  lineageDetailGovernance: 'Zarządzanie',
  lineageDetailSemantic: 'Ontologia',
  lineageAddNode: 'Dodaj węzeł',
  lineageConnect: 'Połącz',
  lineageCancelEdit: 'Anuluj',
  lineageDelete: 'Usuń',
  lineageNodeName: 'Nazwa węzła',
  lineageNodeNamePlaceholder: 'Wpisz nazwę węzła',
  lineageNodeType: 'Typ węzła',
  lineageConfirm: 'Potwierdź',
  lineageRelationType: 'Typ relacji',
  lineageConnectHint: 'Źródło wybrane — kliknij węzeł docelowy',
}
